...
namespace PAPI {
    ...
    public:
        ...
        ///
        /// The size is not mass. It does not affect any particle dynamics, including acceleration and bouncing. It is merely a triple of rendering attributes, like color, and can be interpreted at the whim of the application programmer (thats you). In particular, the three components do not need to be used together as three dimensions of the particles size. For example, one could be interpreted as radius, another as length, and another as density.
        ///
        /// The default size is 1,1,1.
    ...
    public:
        ...
        /// Modify each particles velocity to be similar to that of its neighbors.
        ///
        ...
        /// Modify each particles rotational velocity to be similar to that of its neighbors.
        ///
        ...
        ///
        /// Computes each particles speed (the magnitude of its velocity vector) and if it is less than min_speed or greater than max_speed the velocity is scaled to within those bounds, while preserving the velocity vectors direction.
        ...
        /// Change alpha of all particles toward the specified alpha.
        ///
        /// Modifies the alpha of each particle to be scale percent of the way closer to the specified alpha. scale is multiplied by dt before scaling the sizes. Thus, using smaller dt causes a slightly faster approach to the target alpha.
        ///
        /// The value of scale will usually be very small (less than 0.01) to yield a gradual transition.
        void TargetAlpha(const float alpha, ///< target alpha value
            const float scale ///< what percent of the way from the current alpha to the target alpha to transition in unit time
            );
