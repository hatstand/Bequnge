...
#install_name_tool -id @executable_path/../Frameworks/QtCore.Framework/Versions/4.0/QtCore QtCore.framework/Versions/4/QtCore
cp -R /Library/Frameworks/QtGui.framework $FRMDIR
rm -rf ${FRMDIR}/QtGui.framework/Headers/
#install_name_tool -id @executable_path/../Frameworks/QtGui.Framework/Versions/4.0/QtGui QtGui.framework/Versions/4/QtGui
cp -R /Library/Frameworks/QtOpenGL.framework $FRMDIR
rm -rf ${FRMDIR}/QtOpenGL.framework/Headers/
#install_name_tool -id @executable_path/../Frameworks/QtOpenGL.Framework/Versions/4.0/QtOpenGL QtOpenGL.framework/Versions/4/QtOpenGL
